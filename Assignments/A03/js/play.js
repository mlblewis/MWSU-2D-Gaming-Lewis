var play = {
	...
	spawnObstacle: function (entity, x, y, speed, has_given_point) {
		var dangers = ['obstacle','obstacle1']
		var obs = dangers[Math.floor(Math.random() * 2)]
		var obstacle = this.obstacles.create(x, y, obs, entity)
		speed = 10 * Math.floor(Math.random() *29 + 1) 
