var play2 = {
	create: function () {
		...
		gunFire = this.input.keyboard.addKey(Phaser.Keyboard.X)
		gunFire.onDown.add(this.fireBullets, this.player)
	},
	...
	update: function () {
		...
		if (frame_counter % frames == 0) {
			...
			this.spawnObstacle(game.global.obstacle_id++, w / 2 - platform_width / 2 - gap / 2 + offset, game.height, speed, has_given_point = false)
		}

		this.move();
		gunFire.isDown(this.fireBullets(this.player, bullets))
		frame_counter++
